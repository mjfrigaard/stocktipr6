...
description: "stocktipr6's Bloomberg-inspired dark theme with amber and cyan accents"
...
`stocktipr6` uses a dark, Bloomberg-terminal inspired theme designed for financial data visualization. The theme features:
...
You can extend the theme for your own apps by importing the `stocktipr6_theme()` function:
...
1.  **`stocktipr6_theme()`** - Main `bslib` theme function defining colors, fonts, and surfaces
2.  **`stocktipr6_reactable_theme()`** - Custom `reactable` table styling
