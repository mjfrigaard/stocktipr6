...
The goal of `stocktipr6` is to demonstrate using `R6`s in Shiny applications.
...
`stocktipr6` is a complete, production-ready Shiny application that demonstrates modern R6 design patterns for modular, maintainable Shiny applications. It is functionally equivalent to `stocktipr` but uses object-oriented principles throughout.
